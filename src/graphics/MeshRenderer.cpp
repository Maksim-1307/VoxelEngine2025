...
void MeshRenderer::gen_buffers(MeshType type){
    ...
    switch (type){
        ...
        case MeshType::MESH3D:
            /* layout: float pos X, float poz Y, float pos Z, float UV X, float UV Z, float (packed lighting) R G B S */
            ...
            glVertexAttribPointer(1, 2, GL_FLOAT, GL_TRUE, stride, (GLvoid *)(3 * sizeof(GLfloat)));

            glEnableVertexAttribArray(2);
            glVertexAttribPointer(2, 1, GL_FLOAT, GL_FALSE, stride, (GLvoid *)(5 * sizeof(GLfloat)));
